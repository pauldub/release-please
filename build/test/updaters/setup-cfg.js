...
mocha_1.describe('setup.cfg', () => {
    mocha_1.describe('updateContent', () => {
        mocha_1.it('updates version in setup.cfg', async () => {
            const oldContent = fs_1.readFileSync(path_1.resolve(fixturesPath, './setup.cfg'), 'utf8').replace(/\r\n/g, '\n');
