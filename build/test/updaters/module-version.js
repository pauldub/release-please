...
mocha_1.describe('versions.tf', () => {
    mocha_1.describe('updateContent', () => {
        mocha_1.it('updates version in versions.tf', async () => {
            const oldContent = fs_1.readFileSync(path_1.resolve(fixturesPath, './versions.tf'), 'utf8').replace(/\r\n/g, '\n');
