...
mocha_1.describe('DuneProject', () => {
    mocha_1.describe('updateContent', () => {
        mocha_1.it('updates version in dune-project file', async () => {
            const oldContent = fs_1.readFileSync(path_1.resolve(fixturesPath, './dune-project'), 'utf8').replace(/\r\n/g, '\n');
