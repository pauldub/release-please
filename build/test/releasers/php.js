...
const php_1 = require("../../src/releasers/php");
...
mocha_1.describe('PHP', () => {
    mocha_1.afterEach(() => {
        sandbox.restore();
    });
    mocha_1.it('generates php CHANGELOG and aborts if duplicate', async function () {
        const releasePR = new php_1.PHP({
